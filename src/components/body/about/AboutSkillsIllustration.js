...
const AboutSkillsIllustration = () => {

    const theme = useTheme();

    return (
        <svg width="100" height="50" viewBox="0 0 900 600" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fillRule="evenodd" clipRule="evenodd"
                ...
                fill={theme.palette.particles.main} />
            <path
                ...
                stroke={theme.palette.particles.main} strokeWidth="31" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M582.234 521.076a3.942 3.942 0 1 1-5.575 5.574 3.942 3.942 0 0 1 5.575-5.574z" fill="#323232" />
            <path d="M582.234 521.076a3.942 3.942 0 1 1-5.575 5.574 3.942 3.942 0 0 1 5.575-5.574" stroke={theme.palette.particles.main}
                strokeWidth="31" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M329.973 521.077a3.942 3.942 0 1 1-5.574 5.573 3.942 3.942 0 0 1 5.574-5.573z" fill="#323232" />
            <path d="M329.973 521.077a3.942 3.942 0 1 1-5.574 5.573 3.942 3.942 0 0 1 5.574-5.573" stroke={theme.palette.particles.main}
                strokeWidth="31" strokeLinecap="round" strokeLinejoin="round" />
            <path fillRule="evenodd" clipRule="evenodd"
                ...
                fill={theme.palette.particles.main} />
            <path d="M453.5 432c90.299 0 163.5-72.978 163.5-163s-73.201-163-163.5-163S290 178.978 290 269s73.201 163 163.5 163z"
                fill="#fff" />
            <path
                d="m385.812 235.201-33.913 33.913 33.913 33.913m135.653-67.826 33.913 33.913-33.913 33.913m-50.87-73.423-33.913 79.018"
                stroke={theme.palette.particles.main} strokeWidth="24" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <defs>
...
export default AboutSkillsIllustration;